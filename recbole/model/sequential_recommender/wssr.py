...
from recbole.model.wslayers import FeatureSeqEmbLayer,DIFTransformerEncoder, TransformerEncoder, AttentionFusion, VanillaAttention
...
class WSSR(SequentialRecommender):
    """
    ...
    def __init__(self, config, dataset):
        super(WSSR, self).__init__(config, dataset)
...
########################################################################################################################
    ...
    def forward(self, item_seq, item_seq_len):  
        ...
        # print("\n--------input_emb len-------", len(input_emb))
        # print("\n--------input_emb[0] len-------", len(input_emb[0]))
        # print("\n--------input_emb[0][0] len-------", len(input_emb[0][0]))
        # print("\n--------input_emb size-------", input_emb.size())
        ...
        for feature_embed_layer in self.feature_embed_layer_list:
            ...
            # print("\n--------feature_emb len-------", len(feature_emb))
            # print("\n--------feature_emb[0] len-------", len(feature_emb[0]))
            # print("\n--------feature_emb[0][0] len-------", len(feature_emb[0][0]))
            # print("\n--------feature_emb[0][0][0] len-------", len(feature_emb[0][0][0]))
            # print("\n--------feature_emb[0][0][0][0] len-------", len(feature_emb[0][0][0][0]))
            ...
            # print("\n--------trm_output len:-------", len(trm_output))
            # print("\n--------trm_output[0] len:-------", len(trm_output[0]))
            # print("\n--------trm_output[0][0] len:-------", len(trm_output[0][0]))
            # print("\n--------trm_output[0][0][0] len:-------", len(trm_output[0][0][0]))

            output = trm_output[-1]
            seq_output = self.gather_indexes(output, item_seq_len - 1)

            # print("\n--------seq_output:-------", seq_output.size())
        ...
        # result = torch.median(torch.cat(seq_outputs, dim=-1), dim=0)
        ...
        # # result = torch.sum(torch.stack(weighted_seq_outputs), dim=0)
