...
from recbole.model.wslayers2 import FeatureSeqEmbLayer,DIFTransformerEncoder, TransformerEncoder, AttentionFusion, VanillaAttention, LinearFusionModel
...
class WSSR3(SequentialRecommender):
    """
    ...
    def __init__(self, config, dataset):
        super(WSSR3, self).__init__(config, dataset)
    ...
    def forward(self, item_seq, item_seq_len):  
        ...
        trm_item_output = self.trm_encoder(input_emb, extended_attention_mask, output_all_encoded_layers=True)
